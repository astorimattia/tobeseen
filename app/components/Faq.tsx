...
export default function Faq() {
  return (
    <section id="faq" className="mx-auto max-w-6xl px-4 pb-24">
      <SectionHeading eyebrow="FAQ" title="You asked. We bled a little answering." />
      <div className="space-y-3">
        ...
        <details className="group rounded-xl border border-white/10 bg-zinc-900/30 p-5">
          <summary className="flex cursor-pointer list-none items-center justify-between text-lg font-medium">
            <span>How do you travel?</span>
            <span className="transition group-open:rotate-180" aria-hidden>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M6 9l6 6 6-6"/></svg>
            </span>
          </summary>
          <p className="mt-3 text-zinc-300">
            Word‑of‑mouth and light bags. No hotels, no crew. We sleep where we’re welcomed—on a couch, in a tent, the back of a truck. Locals point us to someone who knows someone. That’s how we find what no one talks about—and keep it real.
          </p>
        </details>
