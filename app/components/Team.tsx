...
export default function Team() {
  const [danieleFallback, setDanieleFallback] = useState(false);
  const [mattiaFallback, setMattiaFallback] = useState(false);
          ...
          <div className="aspect-[4/3] w-full overflow-hidden rounded-xl bg-zinc-800 relative">
            {danieleFallback ? (
              <img 
                ...
                className="object-cover group-hover:scale-[1.02] transition w-full h-full"
              ...
              <Image 
                ...
                onError={() => setDanieleFallback(true)}
              />
            )}
          </div>
          ...
          <div className="aspect-[4/3] w-full overflow-hidden rounded-xl bg-zinc-800 relative">
            {mattiaFallback ? (
              ...
              <Image 
                ...
                placeholder="blur"
                blurDataURL="data:image/jpeg;base64,"
                onError={() => setMattiaFallback(true)}
              />
            )}
          </div>
          <h3 className="mt-4 text-xl font-semibold">
