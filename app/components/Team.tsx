      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <article className="group rounded-2xl border border-white/10 bg-zinc-900/30 p-5">
          <div className="aspect-[4/3] w-full overflow-hidden rounded-xl bg-zinc-800 relative">
            <Image src="/team/daniele.jpg" alt="Daniele Colucci headshot" fill className="object-cover group-hover:scale-[1.02] transition" sizes="(max-width: 768px) 100vw, 50vw" />
          </div>
        ...
        <article className="group rounded-2xl border border-white/10 bg-zinc-900/30 p-5">
          <div className="aspect-[4/3] w-full overflow-hidden rounded-xl bg-zinc-800 relative">
            <Image src="/team/mattia.jpg" alt="Mattia Astori headshot" fill className="object-cover group-hover:scale-[1.02] transition" sizes="(max-width: 768px) 100vw, 50vw" />
          </div>
